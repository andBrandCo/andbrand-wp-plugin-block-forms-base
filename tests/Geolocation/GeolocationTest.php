...
test('Register method will call init hook', function () {
	...
	$this->assertSame(10, \has_filter('init', 'AndbrandWpPluginBlockFormsBase\Geolocation\Geolocation->setLocationCookie()'), 'The callback setLocationCookie should be hooked to init hook with priority 10.');
});

test('Register method will call es_geolocation_is_use_located hook', function () {
	$this->geolocation->register();

	$this->assertSame(10, \has_filter(Geolocation::GEOLOCATION_IS_USER_LOCATED, 'AndbrandWpPluginBlockFormsBase\Geolocation\Geolocation->isUserGeolocated()'), 'The callback isUserGeolocated should be hooked to custom hook with priority 10 and 3 parameters.');
});
