...
test('Register method will call custom hooks', function () {
	...
	$this->assertSame(10, \has_filter(SettingsLocation::FILTER_SETTINGS_SIDEBAR_NAME, 'SebFormsWpPlugin\Settings\Settings\SettingsLocation->getSettingsSidebar()'), 'The callback getSettingsSidebar should be hooked to custom filter hook with priority 10.');
	$this->assertSame(10, \has_filter(SettingsLocation::FILTER_SETTINGS_NAME, 'SebFormsWpPlugin\Settings\Settings\SettingsLocation->getSettingsData()'), 'The callback getSettingsData should be hooked to custom filter hook with priority 10.');
});
