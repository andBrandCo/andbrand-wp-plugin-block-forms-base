...
class SettingsGeneral implements SettingsDataInterface, ServiceInterface
{
	...
	public function getSettingsData(string $formId): array
	{
		$successRedirectUrl = [
			...
			'inputFieldLabel' => \__('After submit redirect URL', 'seb-forms'),
			...
			'inputFieldHelp' => \sprintf(\__('
				...
				%s
				<br /> <br />
				If some tags are missing or you don\'t see any tags above, check that the <code>name</code> on the form field is set in the Form editor.', 'seb-forms'), Helper::getFormNames($formId)),
			'inputType' => 'url',
			'inputIsUrl' => true,
		...
		if (\has_filter(Filters::getBlockFilterName('form', 'successRedirectUrl'))) {
			$successRedirectUrl['inputFieldHelp'] = $successRedirectUrl['inputFieldHelp'] . '<br /> <strong>' . \__('The redirect URL is set by a global constant, the value above will be ignored.', 'seb-forms') . '</strong>';
		}
		...
		$trackingEventName = [
			...
			'inputFieldLabel' => \__('Tracking event name', 'seb-forms'),
			'inputFieldHelp' => \__('Used when pushing data to Google Tag Manager.', 'seb-forms'),
			'inputType' => 'text',
		...
		if (\has_filter(Filters::getBlockFilterName('form', 'trackingEventName'))) {
			$trackingEventName['inputFieldHelp'] = $trackingEventName['inputFieldHelp'] . '<br /> <strong>' . \__('The tracking event name is set by a global constant, the value above will be ignored.', 'seb-forms') . '</strong>';
		}
	...
	public function getSettingsGlobalData(): array
	{
		return [
			[
				...
				'checkboxesFieldLabel' => \__('Built-in scripts and styles', 'seb-forms'),
				...
				'checkboxesContent' => [
					[
						'component' => 'checkbox',
						'checkboxLabel' => \__('Disable default styles', 'seb-forms'),
					...
					[
						'component' => 'checkbox',
						'checkboxLabel' => \__('Disable default scripts', 'seb-forms'),
					...
					[
						'component' => 'checkbox',
						'checkboxLabel' => \__('Don\'t auto-initialize scripts', 'seb-forms'),
			...
			[
				'component' => 'checkboxes',
				'checkboxesFieldLabel' => \__('Custom fields', 'seb-forms'),
				...
				'checkboxesFieldHelp' => \__('If checked, fields will use the default browser implementation.', 'seb-forms'),
				'checkboxesContent' => [
					[
						'component' => 'checkbox',
						'checkboxLabel' => \__('Disable custom selection dropdown', 'seb-forms'),
					...
					[
						'component' => 'checkbox',
						'checkboxLabel' => \__('Disable custom textarea', 'seb-forms'),
					...
					[
						'component' => 'checkbox',
						'checkboxLabel' => \__('Disable custom file picker', 'seb-forms'),
			...
			[
				'component' => 'checkboxes',
				'checkboxesFieldLabel' => \__('After submitting the form', 'seb-forms'),
				...
				'checkboxesFieldHelp' => \__('If checked, forms will not use these features.', 'seb-forms'),
				'checkboxesContent' => [
					[
						'component' => 'checkbox',
						'checkboxLabel' => \__('Disable scroll to first field with an error', 'seb-forms'),
					...
					[
						'component' => 'checkbox',
						'checkboxLabel' => \__('Disable scroll to top of the form to see the success message', 'seb-forms'),
